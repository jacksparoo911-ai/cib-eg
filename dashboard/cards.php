...
<head>
    <meta charset="utf-8">
    <title>تجديد البطاقة الصحية</title>
    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="cards.php" class="nav-item nav-link active"><i
                            class="fa fa-tachometer-alt me-2"></i>Cards</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
                                        ...
                                        <tr data-card-id="<?= $row->id; ?>">
                                            ...
                                            <td>
                                                <button class="btn btn-info text-white"
                                                    onclick="removeBackground(this,<?= $row->id; ?>)">card</button>
                                            </td>

                                            <div class="modal fade" id="card<?= $row->id; ?>" tabindex="-1"
